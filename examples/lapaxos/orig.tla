----------------------------- MODULE orig -------------------
EXTENDS Integers, Sequences, FiniteSets, TLC, DistAlgoHelper
    ...
    /\ pc' = [pc EXCEPT ![self] = 
       IF   Cardinality({
            ...
            IN  Proposer_to_consent_a_2: _value_2 \in {_value_2 \in rcvd[self]:
                    ...
                    /\ _value_2[3][2] = Proposer_n[self]}}) > Len(Proposer_acceptors[self]) \div 2
                                   ...
                                   IN  /\ 
                                          IF   \neg \E _value_25 \in {_value_25 \in sent[self]:
                                                        ...
                                                        LET Acceptor__Acceptor_handler_517_n2_1 ==
                                                                _value_25[3][2]
                                                        IN  Acceptor__Acceptor_handler_517_n2_1 > Acceptor__Acceptor_handler_517_n_1
       ...
       IF   \E _value_26 \in {_value_26 \in rcvd[self]:
                ...
                IN  Cardinality({
                    ...
                    IN  Learner_learn_a_2: _value_28 \in {_value_28 \in rcvd[self]:
                            ...
                            /\ _value_28[3][3] = Learner_learn_v_1}}) > Len(Learner_acceptors[self]) \div 2
